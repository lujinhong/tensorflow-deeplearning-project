...
model_path = 'models/alexnet_miniimagenet_subclass'
...
class AlexNet(models.Model):
    def __init__(self, num_classes):
        ...
        model.add(layers.Conv2D(filters=96, kernel_size=(11, 11), strides=4, padding='valid',
