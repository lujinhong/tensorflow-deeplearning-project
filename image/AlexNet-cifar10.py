...
"""
    AUTHOR: lujinhong
CREATED ON: 2021年09月09日 10:22
   PROJECT: tensorflow-deeplearning-project
   DESCRIPTION: 使用tensorflow2.x实现alexnet，为cifar数据集分类。
"""
...
class AlexNet(models.Model):
    def __init__(self):
        ...
        model.add(layers.Conv2D(filters=96, kernel_size=(11, 11), strides=1, padding='same',
