...
"""
    AUTHOR: lujinhong
CREATED ON: 2021年08月16日 15:16
   PROJECT: tensorflow-deeplearning-project
   DESCRIPTION: 使用tensorflow2.x实现vgg16，为cifar数据集分类。
"""
import os,sys
...
class VGG16(models.Model):
    def __init__(self):
        ...
        model.add(layers.Dense(512,kernel_regularizer=regularizers.l2(weight_decay), activation='relu'))
        model.add(layers.BatchNormalization())
